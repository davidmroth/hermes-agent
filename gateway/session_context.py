...
_SESSION_PUBLIC_BASE_URL: ContextVar = ContextVar("HERMES_SESSION_PUBLIC_BASE_URL", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_SESSION_PUBLIC_BASE_URL": _SESSION_PUBLIC_BASE_URL,
...
def set_session_vars(
    ...
    tokens = [
        ...
        _SESSION_PUBLIC_BASE_URL.set(public_base_url),
    ]
    return tokens
