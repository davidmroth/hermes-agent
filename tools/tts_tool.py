...
def _default_neutts_air_base_url() -> str:
    ...
    return (
        DEFAULT_NEUTTS_AIR_CONTAINER_BASE_URL
        if is_container()
        else DEFAULT_NEUTTS_AIR_HOST_BASE_URL
    )
...
def _resolve_neutts_air_base_url(tts_config: Dict[str, Any]) -> str:
    ...
    raw_url = str(
        ...
        or get_env_value("NEUTTS_AIR_BASE_URL")
...
def _resolve_neutts_air_reference(
